...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/18 16:37:48 by llabonde          #+#    #+#             */
/*   Updated: 2024/07/23 13:38:30 by llabonde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_b_till_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (ft_lstsizeps(*stack_a) > 3 && !ft_checksorted(*stack_a))
	{
		tmp = *stack_a;
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	stack_b = NULL;
	if (ft_lstsizeps(*stack_a) > 3 && !ft_checksorted(*stack_a))
