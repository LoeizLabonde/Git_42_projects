...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/19 14:18:32 by llabonde          #+#    #+#             */
/*   Updated: 2024/07/19 15:59:06 by llabonde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_find_place_b(t_stack *stack_b, int nbr_push)
{
	...
	i = 1;
	if (nbr_push > stack_b->nbr && nbr_push < ft_lstlastps(stack_b)->nbr)
		i = 0;
...
int	ft_find_place_a(t_stack *stack_a, int nbr_push)
{
	...
	i = 1;
	if (nbr_push < stack_a->nbr && nbr_push > ft_lstlastps(stack_a)->nbr)
		i = 0;
