...
- modifiy .env to fill with your own huggingface APIkey and own ip address in FRONTEND_URL, APP_42_CALLBACK and APP_DISCORD_CALLBACK. And make sure that your API app for Oauth2.0 matches APP_42_CALLBACK and APP_DISCORD_CALLBACK.
