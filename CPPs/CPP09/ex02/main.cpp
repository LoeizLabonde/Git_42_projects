...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/29 07:00:51 by llabonde          #+#    #+#             */
/*   Updated: 2025/10/16 07:45:46 by llabonde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char* argv[])
{
    try
    {
        if (argc < 2 || (argc > 3 && strcmp(argv[FIRST_ARGUMENT], TEST_ARG) == 0))
        {
            std::cerr << "Usage: " << argv[0] << " num1 num2 ... numN or " << argv[0] << " tester num or " << argv[0] << " tester" << std::endl;
        ...
        else if (argc == ARG_TWO && strcmp(argv[FIRST_ARGUMENT], TEST_ARG) == STRING_COMPARE_SUCCESS)
        {
            ...
            {
                std::cerr << "Error: Invalid input '" << argv[SECOND_ARGUMENT] << "'. The input must be a positive integer." << std::endl;
                return RETURN_FAILURE;
            }

            long value = std::strtoll(argv[SECOND_ARGUMENT], NULL, 10);

            if (value > INT_MAX)
            {
                std::cerr << "Error: Input value '" << argv[SECOND_ARGUMENT] << "' exceeds the maximum allowed integer value (INT_MAX)." << std::endl;
                return RETURN_FAILURE;
            }

            std::cout << "/* -'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-',-'-,-'- */" << std::endl;
            std::cout << "/*                                 OPTIONNEL                                  */" << std::endl;
            std::cout << "/* -'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-',-'-,-'- */" << std::endl;
        ...
        else
        {
            ...
            for (int i = 1; i < argc; ++i)
            {
                ...
                long verifie = std::strtoll(argv[i], NULL, 10);
